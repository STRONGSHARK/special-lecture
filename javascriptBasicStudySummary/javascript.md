...
document.getElementById(); /*  많이 사용  */

// 해당하는 모든 요소에 접근하기
document.getElementsByTagName(); /*  많이 사용  */

// 해당하는 클래스를 가진 모든 요소에 접근하기
document.getElementsByClassName();

// css 선택자로 단일 요소에 접근하기
document.querySelector("selector"); /*  많이 사용  */

// css 선택자로 여러 요소에 접근하기
document.querySelectorAll("selector");

// target 요소를 생성합니다.
document.createElement(target); /*  많이 사용  */
...
const cont = document.querySelector(".cont"); /*  거의 안씀  */
